...
public class AllTests {
	...
	public static Test suite() {
		TestSuite suite = new TestSuite("Test for com.leipzig48.leipzig.core");
		//$JUnit-BEGIN$
		suite.addTestSuite(SuperparticularIntervalTest.class);
		suite.addTestSuite(PrimeLimitTest.class);
		suite.addTestSuite(ScaleTest.class);
		suite.addTestSuite(IntervalTest.class);
		suite.addTestSuite(UtilitiesTest.class);
		suite.addTestSuite(FiveLimitChordTest.class);
		//$JUnit-END$
		return suite;
	}
}